...
from app.services.post_service import _build_response, _load_poll, _load_polls_batch
...
async def get_home_feed(
    ...
    *,
    ...
    polls = await _load_polls_batch(db, poll_post_ids, current_user.id) if poll_post_ids else {}
